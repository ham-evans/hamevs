...
export default async function VoyagerCommunications() {
  const story = await getGrandaveEntry("voyager-communications");
  ...
  return (
    <main className="flex flex-1 flex-col items-center px-6 py-24">
      <article className="w-full max-w-3xl">
        ...
        <p className="mt-2 text-sm text-fg/50 italic text-center">
          NASA Jet Propulsion Laboratory — November 2, 2020
        </p>
        <div
